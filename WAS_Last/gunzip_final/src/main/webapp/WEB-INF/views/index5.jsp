        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/gunzip_final/index5.do" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>MongoDB Car Log</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">센서 로그</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/gunzip_final/index.do">Home</a></li>
              <li class="breadcrumb-item active">센서 로그</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        	...
        	<!-- DIRECT CHAT -->
                <div class="card direct-chat direct-chat-warning">
                  <div class="card-header">
                    <h3 class="card-title">MongoDB Car LOG</h3>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		timer = setInterval( function () {
			$.ajax ({
				url : "/gunzip_final/mongo/selectCarLog.do?_id="+lastid,
				cache : false,
				success : function (html){
					...
					if(len>0){
						...
						for(var i=0;i<len;i++){
							var msg;
							if(json[i].saveDate!=null){
								msg = json[i].saveDate+'->'+
										'[id]:'+json[i].carnum+
										'[T]'+json[i].temperature+
										'[D]'+json[i].distance+
										'[V]'+json[i].velocity+
										'[F]'+json[i].flame+
										'[G]'+json[i].gas+
